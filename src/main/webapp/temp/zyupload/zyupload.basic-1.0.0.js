...
//					edit             : true,  						      // 是否可以编辑文件（裁剪）
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
				    ...
				    html += '						<div class="uploadImg" style="width:300px">';
				    html += '							<img class="upload_image" src="/temp/zyupload/skins/images/add_img.png" style="width:300px;hight:300px" />';
				    html += '						</div>'; 
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '		<div class="uploadImg" style="300px;">';				
					html += '			<img id="uploadImage_'+file.index+'" class="upload_image" src="' + e.target.result + '" style="width:300px;hight:300px" />';                                                                 
					html += '		</div>';
					html += '	</a>';
