...
var top=_1f.startTop+e.pageY-_1f.startY+48;
    if(top<0)
    top=0;
   
   var maxtop=$(window).height()-$("#sss").height()-$(".center_top").height()-50;
   if(top>maxtop)
   top=maxtop;
   var minleft=$(".right1").width()-$(window).width();
...
//_2a.css("position","absolute");  注释掉了原有代码
...
$.fn.draggable.defaults={proxy:null,revert:false,cursor:"pointer",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onBeforeDrag:function(e){
