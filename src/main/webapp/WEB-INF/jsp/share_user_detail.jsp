			...
			<div class="lt-right">
				...
				<br>
					...
					<c:if test="${not empty friend }">
						...
						<c:if test="${not empty friend.remarkName }">
						<h5>备注名：</h5>
							<input class="ipt form-control" type="text" name="name" id="name"
								style="height: 40px; width: 500px;" value="${friend.remarkName}" readonly="readonly">
						</c:if>
						<h5>电子邮件：</h5>
						<input class="email form-control" name="email" id="email" type="email"
							style="height: 40px; width: 500px;" value="${friend.user.email}" readonly="readonly"> 
						<br>
						<h5>手机或电话号：</h5>
						<input style="width:500px;" class="phone form-control" name="phone" id="phone" type="text"
							value="${friend.user.phone}" readonly="readonly"> 
						<br>
						<h5>QQ号：</h5>
						<input style="width:500px;" class="phone form-control" name="qq" id="qq" type="text"
							value="${friend.user.qq}" readonly="readonly"> 
						<br>
						<h5>微信号：</h5>
