				...
				<!-- list beg -->
					...
					<form action="<s:url value='/employee/searchProxyOrgUsers.html'/>" method="GET"  role="search">
					  <div class="form-group">
						...
						<button  type="button" class="button button-caution button-rounded" onclick="javascript:searchProxyOrgFriends()">好友查询</button>
					  </div>
					</form>
					...
					<table class="table table-bordered table-striped" >
					  ...
					  <c:forEach items="${users}" var="user" varStatus="status">
						<tr>
						  ...
						  <td><a  href='javascript:sendProxyOrgRequest(${user.userId});'>添加为合作机构</a></td>
						</tr>
					  </c:forEach>
					</table>
