				...
				<div class="lt-box" style="padding:20px;">
					...
					<form action="<s:url value='/employee/searchProxyOrgUsers.html'/>" method="GET"  role="search">
					    <div class="form-group">
					      <input class="selectPointOfInterest form-control" type="text" id="form-field-1" style="width:450px;display:inline;" name="keyword" id="keywordId" placeholder="机构用户名/机构名称" value="<c:out value='${param.keyword}'/>"/>                            
...
<script type="text/javascript">
	...
	function searchProxyOrgFriends(){
		var keyword = $("input[name='keyword']").val();
		var url = "<s:url value='/employee/searchProxyOrgFriends.html'/>?keyword=" + keyword;
		location.href = url;
	}
