...
<div class="top navbar-fixed-top">
	...
	<div class="top_nav" style="height:40px; float:left;">
		...
		<div class="col-xs-11" style="min-width:100px;">
			<ul>
			<a href="<s:url value='/patent/list.html?currentPage=1'/>"><li class="nav-hover"><span style="font-weight:900;text-transform: uppercase;font-size:16px;">我的专利</span></li></a>
			<a href="<s:url value='/notice/list.html?currentPage=1'/>"><li><span style="font-weight:900;text-transform: uppercase;font-size:16px;">通知书</span></li></a>
			<a href="<s:url value='/fee/monitoredFeeList.html?currentPage=1'/>"><li><span style="font-weight:900;text-transform: uppercase;font-size:16px;">专利缴费</span></li></a>
			<a href="<s:url value='/friend/list.html'/>"><li><span style="font-weight:900;text-transform: uppercase;font-size:16px;">我的好友</span></li></a>
			<a href="<s:url value='/user/detail.html'/>"><li><span style="font-weight:900;text-transform: uppercase;font-size:16px;">用户中心</span></li></a>
			</ul>		
		</div>	
