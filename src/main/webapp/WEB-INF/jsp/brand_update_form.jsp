							...
							<form method="post" action="<s:url value='/brand/brandUpdate.html'/>">
								<table class="table_con">
									...
									<tr>
										...
										<td>
											...
											<select name="brandCategory.categoryId" class="form-control" style="width:120px;" required>
												<option value="${brand.brandCategory.categoryId}">${brand.brandCategory.categoryName}</option>
									...
									<tr>
										<th>标题</th>
										<td>
											<input class="form-control" style="width:600px;" value="${brand.name}" name="name" required maxlength="50"/>
										</td>
									</tr>
									<tr>
										<th>申请号</th>
									...
									<tr>
										<th>类似群号</th>
										<td>
											<input class="form-control" style="width:600px;" value="${brand.similarNo}" placeholder="" name="similarNo" maxlength="100"/>
										</td>
									</tr>								
									<tr>
										<th>价格</th>
									...
									<tr>
										<th>专有权人</th>
										<td>
											<input class="form-control" style="width:600px;" placeholder="" value="${brand.appPerson}" name="appPerson" maxlength="120"/>
										</td>
									</tr>									
									<tr>
										<th>核定使用商品</th>
										<td>
											<input class="form-control" style="width:600px;" placeholder="" value="${brand.scope}" name="scope" maxlength="100"/>
										</td>
									</tr>
									<tr>
										<th>申请日</th>
