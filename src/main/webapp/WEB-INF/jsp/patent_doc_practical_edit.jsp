...
<!--con beg-->
		<div class="editor-center-con" style="padding:10px;width:930px;max-height:1000px;OVERFLOW:auto;">
         ...
         <div class = "modal-header">
            ...
            <h4 class = "modal-title" id = "myModalLabel">
	         ...
	         <div class = "modal-body" >
			    ...
			    <input style="display: inline-block;width:400px;margin-left:200px;" type="text" class="t-input form-control" id="searchAppersonName" placeholder="请输入联系人姓名" onkeydown="if(event.keyCode==13){searchAppPerson(this.value);}"/>
