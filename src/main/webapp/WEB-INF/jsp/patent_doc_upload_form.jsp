		  ...
		  <div class="col-xs-offset-1 col-xs-11">
			<div class="lt-right">
				...
				<div class="lt-box" style="height:300px;padding:20px;">
					<form id="patentDocFileForm" action="<s:url value='/editor/uploadPatentDocFile.html'/>" method="post" enctype="multipart/form-data" class="form-horizontal">  
...
<script type="text/javascript">
	...
	function uploadSuccess(value){
		...
		$.ajax({
			type: "POST",
			url: "<s:url value='/editor/savePatentDocFile.html'/>",
			data: {"patentDocId":patentDocId,"patentDocUrl":value},
