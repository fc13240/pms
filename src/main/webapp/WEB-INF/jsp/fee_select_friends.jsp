		  ...
		  <div class="col-xs-offset-1 col-xs-11">
			<div class="lt-right">
				...
				<div class="lt-box" style="padding:20px;height:400px;">
					  <h4>请选择要分配的好友 </h4>
					  <div>
						<form action="<s:url value='/fee/searchFriends.html'/>" method="get"  id="shareAddForm">
						  <c:forEach items="${paramValues.fees}" var="fee">
							<input type="hidden" class="form-control" name="fees" value="<c:out value='${fee}'/>">
						  </c:forEach>
					  ...
					  <div style="margin-top:20px;width:500px;">
						<form action="<s:url value='/fee/shareFees.html'/>" method="get"  id="shareAddForm">
						  <c:forEach items="${paramValues.fees}" var="fee">
							<input type="hidden" name="fees" value="<c:out value='${fee}'/>">
						  </c:forEach>
