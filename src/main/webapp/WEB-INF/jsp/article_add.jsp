								...
								<table class="table_con">
									...
									<tr>
										...
										<td>
											...
											<select name="articleType.typeId" class="form-control" style="width:120px;" id="" onchange="bindSortChild()" required>
									...
									<tr>
										<th>内容</th>
										<td>
											<textarea rows="3" cols="10" id="articleContent" name="content" class="articleContent" style="width:520px;height:200px;visibility:hidden;">
											</textarea>
										</td>
									</tr>
