...
<div class="row">
	<div class="col-lg-12">
		<form action="<s:url value='/notice/upload.html'/>" method="post" enctype="multipart/form-data" class="form-horizontal" id="notice-upload-form">
			<se:csrfInput />
			<fieldset>
				<legend>上传通知书</legend>
				...
				<button type="button" id="browser" class="btn btn-primary btn-browser" onclick="$('input[id=noticeFile]').click();">浏览</button>	
...
<script type="text/javascript">
	$('input[id=noticeFile]').change(function() {  
