...
<!-- sidebar -->
    <div id="sidebar" class="sidebar                  responsive"> 
      ...
      <ul class="nav nav-list">
        ...
        <li class="active"> <a href="<s:url value='/notice/showUploadForm.html'/>"> <i class="menu-icon fa fa-picture-o"></i> <span class="menu-text"> 添加通知书 </span> </a> <b class="arrow"></b> </li>
										...
										<div class="col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">添加通知书</h4>
