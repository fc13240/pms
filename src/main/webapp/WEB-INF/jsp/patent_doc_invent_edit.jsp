...
<body style="font-family: 'microsoft yahei',微软雅黑 !important;">
<style>
		...
		<div class="editor-center-con" style="width:930px;padding:10px;max-height:1000px;OVERFLOW:auto;">
			...
			<div class="center_content" id="content0">
				...
				<div class="patent_other">
					...
					<div style="height:10px;">&nbsp;</div>
					<textarea id="otherInformation" style="width:900px;" class="t-input form-control" rows="6" cols="60" placeholder="请填写，若没有则可以不填写。">${patentDoc.otherInformation }</textarea>
         ...
         <div class = "modal-header">
            ...
            <h4 class = "modal-title" id = "myModalLabel">
	         ...
	         <div class = "modal-body" id="modal-body">
					...
					<span style="color: red; display: none;" id="appPersonTransactionIdentityIdError">请输入备案证件号在50字以内</span>
					<br>
					<h5>备案年度:</h5>
         ...
         <div class = "modal-header">
            ...
            <h4 class = "modal-title" id = "myModalLabel">
	         ...
	         <div class = "modal-body" id="modal-body">
					...
					<span style="color: red; display: none;" id="updateAppPersonNameError">请输入长度不超过200字符</span>
					<br>
					<h5><span style="color:red;font-size:18px;">* </span>证件号码:</h5>
					...
					<br>		  
					<h5><span style="color:red;font-size:18px;">* </span>邮编及地址:</h5>
					<input class="selectPointOfInterest form-control" style="width:460px;" id="updateModalPostcodeAddress" type="text"/>
					...
					<span style="color: red; display: none;" id="updateModalTransactionIdentityIdError">请输入备案证件号在50字以内</span>
					<br>
					<h5>备案年度:</h5>
