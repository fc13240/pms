		  ...
		  <div class="col-xs-offset-1 col-xs-11">
			<div class="lt-right">
				...
				<div class="lt-box" style="padding:20px;">
					...
					<br>		  
			       	<h5>邮编及地址:</h5>
					<input class="selectPointOfInterest form-control" style="width:600px;" id="numberRece1" type="text" name="postcodeAddress" required onblur="validateInfoNumber1(this.value)"/>
