  ...
  <div style="float:left;width:95%;">
    <div class="center-cconcenct">
      ...
      <div class="con-list" style="float:left;width:91%;">
        <div class="t-ti">
          <hr class="t-hr">
          <span style="font-size: 16px;font-weight: 300;line-height: 24px;">专利缴费</span> </div>
				  ...
				  <div class="row">
					<div class="col-xs-12">
					  ...
					  <span class="input-group-btn" > 
						...
						<a href="javascript:batchUpdateInvoiceTitles()"><button class="t-btn1">批量修改发票抬头</button></a>							
						<a href="javascript:exportFees()"><button class="t-btn6">表格导出</button></a>
						<a href="javascript:showOrderCreateForm()"><button class="t-btn5">在线支付</button></a>
						</div>					  
					  </span> </div>
