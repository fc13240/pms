...
public interface Settings {
	...
	final String PATENTDOC_IMAGE_PATH = "/opt/media/pic/";
	final String PATENTDOC_ATTACHMENT_PATH = "/opt/media/attachmentImg/";
	...
	final String PATENTDOC_ATTACHMENT_FILE_PATH = "/opt/media/attachmentFile/";
